          ...
          {newMatches.length === 0 ? (
            <div style={{ textAlign:"center", padding:"60px 0", color:"rgba(255,255,255,.3)" }}>
              ...
              <button className="btn-red" style={{ marginTop:20, padding:"11px 28px", fontSize:13 }}
                onClick={() => navigate("/app/discover")}>Go to Discover →</button>
            </div>
          ) : (
            <>
              ...
              <div style={{ display:"flex", gap:10, overflowX:"auto", paddingBottom:8, marginBottom:8 }}>
                {newMatches.map(m => (
                  <div key={m.id} onClick={() => { setChatUser(m); navigate("/app/chat"); }}
                ...
                <div className="user-row" onClick={() => { setChatUser(m); navigate("/app/chat"); }}>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", gap:6 }}>
                    ...
                    <button className="btn-red" style={{ padding:"7px 14px", fontSize:11 }}
                      onClick={e => { e.stopPropagation(); setChatUser(m); navigate("/app/chat"); }}>
                      Say Hi 👋
                    </button>
                  </div>
                </div>
          ...
          {chats.length === 0 ? (
            ...
            return (
              <div key={m.id} className="user-row" style={{ alignItems:"flex-start" }}
                onClick={() => { setChatUser(m); navigate("/app/chat"); }}>
                <div style={{ position:"relative", flexShrink:0 }}>
